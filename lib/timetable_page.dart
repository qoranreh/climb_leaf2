  ...
  class _TimetablePageState extends State<TimetablePage> {
    ...
    void showSummaryModal(BuildContext context) async {
      ...
      String selectedTask = taskSummary.isNotEmpty ? taskSummary.keys.first : ''; // 초기 선택 Task
                      ...
                      children: taskSummary.keys.map((task) {
                        return ElevatedButton(
                          ...
                          child: Text(
                            task,
                            style: TextStyle(
                              color: selectedTask == task ? Colors.white : Colors.black,
                            ),
                          ),
                        );
                      }).toList(),
                    ...
                    AspectRatio(
                      ...
                      child: LineChart(
                        LineChartData(
                          ...
                          minY: 0,
                          maxY: taskCounts.reduce((a, b) => a > b ? a : b).toDouble() + 1,
                          lineBarsData: [
                            LineChartBarData(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () {
                Map<DateTime, Map<String, int>> wrappedTaskData = taskData.map((date, count) {
